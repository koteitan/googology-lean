...
| `Closure.lean` | concatenation, `G°`, `⊲`, and Buchholz 3.5 |
...
standard-form condition outright. `Closure.lean` has the vocabulary and both halves of
3.5, each resting on a decomposition lemma for terms lying strictly between
two others.

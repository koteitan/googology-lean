...
| `Closure.lean` | concatenation, `G°`, `⊲`, and Buchholz 3.4 and 3.5 |
...
halves of 3.5. What is left is 3.6, which has to follow `fs` branch by branch,
and then 3.3, which assembles the two.

...
/-!
# Fix L against the sheet, the checks of `TrioRulesAllSheet.lean`, and its own item

`TrioFixLastLeaf.lean` patches `TrioRulesAll.lean` (rules 1–10 of
[koteitan/trio](https://github.com/koteitan/trio) with Fixes A–E and N): a last leaf
naming `Ω_p` for some `p` under a tower regime.  This file

* re-runs **every** check of `TrioRulesAllSheet.lean` (Parts 1–7) for the patched
  rules: `trioRuleMatrixOfFix`, `fixOf`, `MFix`, `MstepFix` in place of
  `trioRuleMatrixOfAll`, `allOf`, `MAll`, `MstepAll`.  All of them hold with the same
  numbers: the 813 sheet rows and 9 corrected labels, the order checks of the 783 and
  784 chosen matrices (0 disagreements), the guards of Fixes A–E and N, the nearby
  families, the interactions of Fix E and Fix N, and the step-level comparison with
  rules 1–10;
* checks that Fix L changes no label used there (Part 0);
* adds Fix L's own checks (Part 8): the six matrices, the four cases as identities,
  the order around them, 21 BMS expansions that land on Fix L's matrices, and a
  family of 151 last leaves (0 disagreements, 0 collisions, all standard).

Standard form is yaBMS `bms -s`, outside Lean.  All of it is `#guard`s: a
...
#guard trioRuleMatrixOfFix "(W5)" -- row 2433
...
#guard trioRuleMatrixOfFix "(W_2*3)" -- row 2725
...
#guard trioRuleMatrixOfFix "(W_3+W_2)" -- row 2798
...
#guard trioRuleMatrixOfFix "(W_3*2)" -- row 2799
...
#guard trioRuleMatrixOfFix "W_6" -- row 2810
...
#guard trioRuleMatrixOfFix "(W_w+W+2)" -- row 3368
...
#guard trioRuleMatrixOfFix "(W_w+W+w)" -- row 3369
...
#guard trioRuleMatrixOfFix "(W_w+W+w^2)" -- row 3370
...
#guard trioRuleMatrixOfFix "(W_w+W2)" -- row 3371
...
#guard trioRuleMatrixOfFix "(W_w+W*w)" -- row 3372
...
#guard trioRuleMatrixOfFix "(W_w+W^2)" -- row 3373
...
#guard trioRuleMatrixOfFix "(W_w+W^W)" -- row 3374
...
#guard trioRuleMatrixOfFix "(W_w+psi_1(W_w))" -- row 3375
...
#guard trioRuleMatrixOfFix "(W_w+W_2)" -- row 3376
...
#guard trioRuleMatrixOfFix "(W_w+W_3)" -- row 3377
...
#guard trioRuleMatrixOfFix "(W_w*W+w)" -- row 3479
...
#guard trioRuleMatrixOfFix "(W_w*W*w)" -- row 3483
...
#guard trioRuleMatrixOfFix "(W_w*W*w^2)" -- row 3484
...
#guard trioRuleMatrixOfFix "(W_w*W*w^w)" -- row 3485
...
#guard trioRuleMatrixOfFix "(W_w*W^2)" -- row 3486
...
#guard trioRuleMatrixOfFix "(W_w*W^3)" -- row 3487
...
#guard trioRuleMatrixOfFix "(W_w*W^w)" -- row 3488
...
#guard trioRuleMatrixOfFix "(W_w*W^W)" -- row 3489
...
#guard trioRuleMatrixOfFix "(W_w*psi_1(W_w))" -- row 3490
...
#guard trioRuleMatrixOfFix "(W_w*W_2)" -- row 3491
...
#guard trioRuleMatrixOfFix "(W_w*W_3)" -- row 3493
...
#guard trioRuleMatrixOfFix "(W_(w+2)+w2)" -- row 3780
...
#guard trioRuleMatrixOfFix "(W_(w+2)+w^2)" -- row 3781
...
#guard trioRuleMatrixOfFix "(W_(w+2)+W)" -- row 3782
...
#guard trioRuleMatrixOfFix "(W_(w+2)+W_w)" -- row 3783
...
#guard trioRuleMatrixOfFix "(W_(w+2)+W_(w+1))" -- row 3784
...
#guard trioRuleMatrixOfFix "(W_(w+2)*2)" -- row 3785
...
#guard trioRuleMatrixOfFix "(W_(w+2)*3)" -- row 3786
...
#guard trioRuleMatrixOfFix "(W_(w+3)*w)" -- row 3801
...
#guard trioRuleMatrixOfFix "W_(w+4)" -- row 3802
...
#guard trioRuleMatrixOfFix "(W_(w2+1)+w)" -- row 3915
...
#guard trioRuleMatrixOfFix "(W_(w2+1)+w^2)" -- row 3916
...
#guard trioRuleMatrixOfFix "(W_(w2+1)+W)" -- row 3917
...
#guard trioRuleMatrixOfFix "(W_(w2+1)*2)" -- row 3918
...
#guard trioRuleMatrixOfFix "(W_(w2+1)^2)" -- row 3921
...
#guard trioRuleMatrixOfFix "(W_(w3)+w)" -- row 3943
...
#guard trioRuleMatrixOfFix "(W_(w3)+w^2)" -- row 3944
...
#guard trioRuleMatrixOfFix "(W_(w3)+W)" -- row 3945
...
#guard trioRuleMatrixOfFix "(W_(w3)+W_(w2+1))" -- row 3946
...
#guard trioRuleMatrixOfFix "(W_(w3)*2)" -- row 3947
...
#guard trioRuleMatrixOfFix "(W_(w3)*w)" -- row 3948
...
#guard trioRuleMatrixOfFix "(W_(w3)^2)" -- row 3949
...
#guard trioRuleMatrixOfFix "psi_W_(w3+1)(W_(w3+1))" -- row 3950
...
#guard trioRuleMatrixOfFix "(W_(w^2*2)+W_(w^2))" -- row 4333
...
#guard trioRuleMatrixOfFix "(W_(w^2*2)+W_(w^2+1))" -- row 4334
...
#guard trioRuleMatrixOfFix "(W_(w^2*2)*2)" -- row 4335
...
#guard trioRuleMatrixOfFix "(W_W+2)" -- row 4452
...
#guard trioRuleMatrixOfFix "(W_W+w)" -- row 4453
...
#guard trioRuleMatrixOfFix "(W_W+w^2)" -- row 4454
...
#guard trioRuleMatrixOfFix "(W_W+W)" -- row 4455
...
#guard trioRuleMatrixOfFix "(W_W+W_2)" -- row 4456
...
#guard trioRuleMatrixOfFix "(W_W+W_w)" -- row 4457
...
#guard trioRuleMatrixOfFix "(W_W*2)" -- row 4458
...
#guard trioRuleMatrixOfFix "(W_W*3)" -- row 4459
...
#guard trioRuleMatrixOfFix "(W_W*W_2)" -- row 4462
...
#guard trioRuleMatrixOfFix "(W_W*W_w)" -- row 4463
...
#guard trioRuleMatrixOfFix "(W_W^2)" -- row 4464
...
#guard trioRuleMatrixOfFix "(W_W^W_W)" -- row 4465
...
#guard trioRuleMatrixOfFix "(W_(W+1)+w)" -- row 4486
...
#guard trioRuleMatrixOfFix "(W_(W+1)+W_2)" -- row 4487
...
#guard trioRuleMatrixOfFix "(W_(W+1)*2)" -- row 4489
...
#guard trioRuleMatrixOfFix "psi_W_(W+2)(W_(W+2))" -- row 4492
...
#guard trioRuleMatrixOfFix "W_(W+2)" -- row 4493
...
#guard trioRuleMatrixOfFix "W_(W+3)" -- row 4494
...
#guard trioRuleMatrixOfFix "W_(W+w^2)" -- row 4500
...
#guard trioRuleMatrixOfFix "W_(W+w^w)" -- row 4501
...
#guard trioRuleMatrixOfFix "W_(W2)" -- row 4502
...
#guard trioRuleMatrixOfFix "W_(W3)" -- row 4503
...
#guard trioRuleMatrixOfFix "(W_W_w+w)" -- row 4607
...
#guard trioRuleMatrixOfFix "(W_W_w+W)" -- row 4608
...
#guard trioRuleMatrixOfFix "(W_W_w+W_(w+1))" -- row 4610
...
#guard trioRuleMatrixOfFix "(W_W_w+W_(w2))" -- row 4611
...
#guard trioRuleMatrixOfFix "(W_W_w+W_W)" -- row 4612
...
#guard trioRuleMatrixOfFix "(W_W_w*w)" -- row 4614
...
#guard trioRuleMatrixOfFix "(W_W_w*W)" -- row 4615
...
#guard trioRuleMatrixOfFix "(W_W_w*W_(w+1))" -- row 4616
...
#guard trioRuleMatrixOfFix "(W_W_w*W_W)" -- row 4617
...
#guard trioRuleMatrixOfFix "psi_W_(W_w+1)(W_(W_w+1))" -- row 4619
...
#guard trioRuleMatrixOfFix "W_(W_w+w)" -- row 4622
...
#guard trioRuleMatrixOfFix "W_(W_w*2)" -- row 4623
...
#guard trioRuleMatrixOfFix "W_(W_w*3)" -- row 4624
...
#guard trioRuleMatrixOfFix "(W_W_(w+1)*2)" -- row 4641
...
#guard trioRuleMatrixOfFix "(W_W_(w+1)*w)" -- row 4642
...
#guard trioRuleMatrixOfFix "(W_W_(w+1)^2)" -- row 4643
...
#guard trioRuleMatrixOfFix "W_(W_(w+1)+1)" -- row 4644
...
#guard trioRuleMatrixOfFix "W_(W_(w+1)*2)" -- row 4645
...
#guard trioRuleMatrixOfFix "W_(W_(w+1)*w)" -- row 4646
...
#guard trioRuleMatrixOfFix "W_(W_(w+1)^2)" -- row 4647
...
#guard trioRuleMatrixOfFix "W_W_(w+2)" -- row 4648
...
#guard trioRuleMatrixOfFix "W_W_(w3)" -- row 4651
...
#guard trioRuleMatrixOfFix "W_W_(w^2)" -- row 4652
  = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1]]
#guard trioRuleMatrixOfFix "(W_W_(w^2)+1)" -- row 4665
...
#guard trioRuleMatrixOfFix "(W_W_(w^2)+W_(w^2+1))" -- row 4666
...
#guard trioRuleMatrixOfFix "(W_W_(w^2)*w)" -- row 4668
...
#guard trioRuleMatrixOfFix "W_(W_(w^2)+1)" -- row 4669
...
#guard trioRuleMatrixOfFix "W_(W_(w^2)+W)" -- row 4670
...
#guard trioRuleMatrixOfFix "W_(W_(w^2)*2)" -- row 4671
...
#guard trioRuleMatrixOfFix "(W_W_W+w)" -- row 4741
...
#guard trioRuleMatrixOfFix "(W_W_W+W_2)" -- row 4742
...
#guard trioRuleMatrixOfFix "(W_W_W+W_w)" -- row 4743
...
#guard trioRuleMatrixOfFix "(W_W_W*w)" -- row 4748
...
#guard trioRuleMatrixOfFix "(W_W_W*W_2)" -- row 4749
...
#guard trioRuleMatrixOfFix "psi_W_(W_W+1)(W_(W_W+1))" -- row 4754
...
#guard trioRuleMatrixOfFix "W_(W_W+1)" -- row 4755
...
#guard trioRuleMatrixOfFix "W_(W_W+w)" -- row 4756
...
#guard trioRuleMatrixOfFix "W_(W_W+W_2)" -- row 4757
...
#guard trioRuleMatrixOfFix "W_(W_W*2)" -- row 4758
...
#guard trioRuleMatrixOfFix "W_(W_W*w)" -- row 4759
...
#guard trioRuleMatrixOfFix "W_(W_W*W_2)" -- row 4760
...
#guard trioRuleMatrixOfFix "W_(W_W^2)" -- row 4761
...
#guard trioRuleMatrixOfFix "W_W_(W+1)" -- row 4763
...
#guard trioRuleMatrixOfFix "W_W_(W+w)" -- row 4764
...
#guard trioRuleMatrixOfFix "W_W_(W2)" -- row 4765
...
#guard trioRuleMatrixOfFix "W_W_(W*w)" -- row 4766
...
#guard trioRuleMatrixOfFix "W_W_(W^2)" -- row 4767
...
#guard trioRuleMatrixOfFix "W_W_(W^W)" -- row 4768
...
#guard trioRuleMatrixOfFix "W_W_W_2" -- row 4770
...
#guard trioRuleMatrixOfFix "W_W_W_3" -- row 4771
...
#guard trioRuleMatrixOfFix "W_W_W_w" -- row 4772
  = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1]]
#guard trioRuleMatrixOfFix "W_W_W_(w+1)" -- row 4773
...
#guard trioRuleMatrixOfFix "W_W_W_(w2)" -- row 4774
...
-- row 3492 (S-o)
#guard trioRuleMatrixOfFix "(W_w*W_2*w)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[4,2,1],[5,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[5,3,1],[6,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[6,4,1],[7,2,0],[6,4,1]]
...
-- row 4488 (S-o)
#guard trioRuleMatrixOfFix "(W_(W+1)+W_W)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,2,0],[2,2,1],[3,2,1],[4,1,0]]
...
-- row 4490 (S-o)
#guard trioRuleMatrixOfFix "(W_(W+1)*w)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[6,4,1]]
...
-- row 4491 (S-o)
#guard trioRuleMatrixOfFix "(W_(W+1)^2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[6,4,1],[7,3,0]]
...
-- row 4497 (S-c)
#guard trioRuleMatrixOfFix "(W_(W+w)*w)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,1]]
...
-- row 4508 (S-o)
#guard trioRuleMatrixOfFix "W_psi_1(W_2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[5,2,0]]
...
-- row 4609 (S-o)
#guard trioRuleMatrixOfFix "(W_W_w+W_w)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,1],[5,1,0],[4,2,0],[5,3,1],[6,3,1],[7,2,0],[6,3,0],[7,4,1],[8,4,1],[9,1,0],[1,1,1]]
...
-- row 4613 (S-o)
#guard trioRuleMatrixOfFix "(W_W_w*2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,1],[5,1,0],[4,2,0],[5,3,1],[6,3,1],[7,2,0],[6,3,0],[7,4,1],[8,4,1],[9,2,0],[3,2,1],[4,2,1],[5,1,0],[1,1,1]]
...
-- row 4618 (S-o)
#guard trioRuleMatrixOfFix "(W_W_w^2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,1],[5,1,0],[4,2,0],[5,3,1],[6,3,1],[7,2,0],[6,3,1],[7,2,0],[3,2,1],[4,2,1],[5,1,0],[1,1,1]]
...
-- row 4628 (S-o)
#guard trioRuleMatrixOfFix "W_psi_W_(w+1)(W_(w+1))" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,1],[5,1,0],[6,2,0]]
...
-- row 4667 (S-c)
#guard trioRuleMatrixOfFix "(W_W_(w^2)*2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,1],[5,1,0],[4,2,0],[5,3,1],[6,3,1],[7,2,0],[6,3,0],[7,4,1],[8,4,1],[9,2,0],[3,2,1],[4,2,1],[5,1,0],[1,1,1],[2,1,1]]
...
-- row 4674 (S-o)
#guard trioRuleMatrixOfFix "W_(psi_W_(w^2+1)(W_(w^2+1)))" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,1],[5,1,0],[6,2,0]]
...
-- row 4744 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W+W_W)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,2,0],[2,2,1],[3,2,1],[4,1,0]]
...
-- row 4745 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W+W_(W+1))" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0]]
...
-- row 4746 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W+W_W_2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,2,0]]
...
-- row 4747 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W*2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,2,0],[2,2,1],[3,2,1],[4,1,0]]
...
-- row 4750 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W*W_W)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,1],[8,2,0],[2,2,1],[3,2,1],[4,1,0]]
...
-- row 4751 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W*W_(W+1))" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,1],[8,3,0]]
...
-- row 4752 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W*W_W_2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,1],[8,3,0],[4,3,1],[5,3,1],[6,2,0]]
...
-- row 4753 (S-c)
#guard trioRuleMatrixOfFix "(W_W_W^2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,1],[8,3,0],[4,3,1],[5,3,1],[6,2,0],[2,2,1],[3,2,1],[4,1,0]]
...
-- row 4762 (S-o)
#guard trioRuleMatrixOfFix "W_psi_W_(W+1)(W_(W+1))" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[7,3,0]]
...
-- row 4769 (S-o)
#guard trioRuleMatrixOfFix "W_W_psi_1(W_2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[5,2,0]]
...
#guard trioRuleMatrixOfFix "(w^5*2)" = some [[0,0,0],[1,1,1],[2,1,1],[2,1,1],[2,1,1],[2,1,1],[2,1,0],[3,2,1],[4,2,1],[4,2,1],[4,2,1],[4,2,1]]
#guard trioRuleMatrixOfFix "(w^5*3)" = trioRuleMatrixOf "(w^5*3)"
-- row 2131, printed `(w^w+w2)`, corrected `(w^w+2)`
#guard trioRuleMatrixOfFix "(w^w+2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,0,0],[2,1,0],[3,2,0],[4,3,0]]
#guard trioRuleMatrixOfFix "(w^w+w2)" = trioRuleMatrixOf "(w^w+w2)"
-- row 2532, printed `(W^(W+1))`, corrected `(W^(w+1))`
#guard trioRuleMatrixOfFix "(W^(w+1))" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,1,0],[4,0,0],[3,2,1],[4,1,0]]
#guard trioRuleMatrixOfFix "(W^(W+1))" = trioRuleMatrixOf "(W^(W+1))"
-- row 2723, printed `(W_2*2+W)`, corrected `(W_2*2+w^2)`
#guard trioRuleMatrixOfFix "(W_2*2+w^2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,0],[3,3,1],[4,3,1],[5,2,0],[4,3,0],[5,4,1],[6,4,1],[7,2,0],[6,4,0],[7,5,1],[8,5,1]]
#guard trioRuleMatrixOfFix "(W_2*2+W)" = trioRuleMatrixOf "(W_2*2+W)"
-- row 3452, printed `(W_w*w+W_w+10)`, corrected `(W_w*w+W_w+1)`
#guard trioRuleMatrixOfFix "(W_w*w+W_w+1)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[4,2,1],[4,2,0],[5,3,1],[6,3,1],[7,1,0],[6,3,0],[7,4,0]]
#guard trioRuleMatrixOfFix "(W_w*w+W_w+10)" = trioRuleMatrixOf "(W_w*w+W_w+10)"
-- row 3552, printed `psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1)))`, corrected `psi_W_(w+1)(W_psi_W_(w+1)(W_(w+1)))`
#guard trioRuleMatrixOfFix "psi_W_(w+1)(W_psi_W_(w+1)(W_(w+1)))" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[6,2,1],[7,2,1],[8,1,0],[9,2,0]]
-- Fix E: the printed label now gets `TrioRules3`'s matrix, not rules 1–10's.
#guard trioRuleMatrixOfFix printed3552 = trioRuleMatrixOf3 printed3552
#guard trioRuleMatrixOfFix printed3552 ≠ trioRuleMatrixOf printed3552
-- row 3777, printed `(W_(w+2)+w)`, corrected `(W_(w+2)+2)`
#guard trioRuleMatrixOfFix "(W_(w+2)+2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,0],[8,6,0]]
#guard trioRuleMatrixOfFix "(W_(w+2)+w)" = trioRuleMatrixOf "(W_(w+2)+w)"
-- row 4369, printed `(W_(w^3*W))`, corrected `(W_(w^3)*W)`
#guard trioRuleMatrixOfFix "(W_(w^3)*W)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[2,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[4,2,1],[5,1,0]]
#guard trioRuleMatrixOfFix "(W_(w^3*W))" = trioRuleMatrixOf "(W_(w^3*W))"
-- row 4384, printed `W_(w^2*2)`, corrected `W_(w^w*2)`
#guard trioRuleMatrixOfFix "W_(w^w*2)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,0,0],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,1],[5,0,0]]
#guard trioRuleMatrixOfFix "W_(w^2*2)" = trioRuleMatrixOf "W_(w^2*2)"

/-! ### The 8 rows where the rules are right and the sheet has another matrix -/

-- row 2133 (R)
#guard trioRuleMatrixOfFix "(w^w+w2)" = trioRuleMatrixOf "(w^w+w2)"
#guard trioRuleMatrixOfFix "(w^w+w2)" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,0,0],[2,1,0],[3,2,1],[3,2,0],[4,3,1]]
-- row 3453 (N)
#guard trioRuleMatrixOfFix "(W_w*w+W_w*2)" = trioRuleMatrixOf "(W_w*w+W_w*2)"
#guard trioRuleMatrixOfFix "(W_w*w+W_w*2)" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[4,2,1],[4,2,0],[5,3,1],[6,3,1],[7,1,0],[6,3,0],[7,4,1],[8,4,1],[9,1,0]]
-- row 3551 (R (weak))
#guard trioRuleMatrixOfFix "psi_W_(w+1)(W_W_w)" = trioRuleMatrixOf "psi_W_(w+1)(W_W_w)"
#guard trioRuleMatrixOfFix "psi_W_(w+1)(W_W_w)" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[6,2,1],[7,2,1],[8,1,0],[1,1,1]]
-- row 3706 (N)
#guard trioRuleMatrixOfFix "(W_(w+1)+W_w^2)" = trioRuleMatrixOf "(W_(w+1)+W_w^2)"
#guard trioRuleMatrixOfFix "(W_(w+1)+W_w^2)" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,1,0],[8,1,0],[1,1,1]]
-- row 3709 (N)
#guard trioRuleMatrixOfFix "(W_(w+1)*2+W)" = trioRuleMatrixOf "(W_(w+1)*2+W)"
#guard trioRuleMatrixOfFix "(W_(w+1)*2+W)" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,2,0],[7,4,0],[8,5,1]]
-- row 3923 (R)
#guard trioRuleMatrixOfFix "psi_W_(w2+2)(W_(w2+2))" = trioRuleMatrixOf "psi_W_(w2+2)(W_(w2+2))"
#guard trioRuleMatrixOfFix "psi_W_(w2+2)(W_(w2+2))" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,0],[5,3,1],[6,3,1],[7,3,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[9,3,0]]
-- row 4303 (N)
#guard trioRuleMatrixOfFix "(W_(w^2+w)^W_(w^2+w))" = trioRuleMatrixOf "(W_(w^2+w)^W_(w^2+w))"
#guard trioRuleMatrixOfFix "(W_(w^2+w)^W_(w^2+w))" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[2,1,0],[3,2,1],[4,2,1],[5,2,0],[3,2,1],[4,2,0],[5,3,1],[6,3,1],[7,2,0],[8,2,0],[3,2,1]]
-- row 4496 (N)
#guard trioRuleMatrixOfFix "(W_(W+w)+1)" = trioRuleMatrixOf "(W_(W+w)+1)"
#guard trioRuleMatrixOfFix "(W_(W+w)+1)" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1]]

/-! ### Rows 3439 and 3480: unchanged -/

-- row 3439 (X)
#guard trioRuleMatrixOfFix "(W_w*w0*W_W_w+W_(W_w*w))" = trioRuleMatrixOf "(W_w*w0*W_W_w+W_(W_w*w))"
#guard trioRuleMatrixOfFix "(W_w*w0*W_W_w+W_(W_w*w))" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[4,2,1],[4,2,0],[3,2,1],[4,2,1],[5,1,0],[4,2,0],[5,3,1],[6,3,1],[7,1,0],[6,3,1],[6,2,0],[5,3,1],[6,3,1],[7,1,0],[6,3,1]]
-- row 3480 (O)
#guard trioRuleMatrixOfFix "(W_w*W+W_3)" = trioRuleMatrixOf "(W_w*W+W_3)"
#guard trioRuleMatrixOfFix "(W_w*W+W_3)" ≠ some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,0],[3,2,1],[4,2,1],[5,1,0],[4,2,1],[5,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[5,3,1],[6,1,0],[5,3,0],[6,4,1],[7,4,1],[8,1,0],[7,4,1]]
...
#guard trioRuleMatrixOfFix "W_psi_2(W_3)" = some [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,2,0],[6,3,0]]
...
def chosenDataFix : Array (Od × List (List Nat)) :=
  (chosen.map fun s => ((parse s).getD [], fixOf s)).toArray

#guard chosenDataFix.size = 783
#guard chosenDataFix.all fun p => !p.1.isEmpty && !p.2.isEmpty
#guard orderDisagreements chosenDataFix = 0
...
#guard allLabels.all fun s => trioRuleMatrixOfFix s == trioRuleMatrixOf3 s
#guard (allLabels.filter (· != printed3552)).all fun s => trioRuleMatrixOfFix s == trioRuleMatrixOf2 s
#guard trioRuleMatrixOfFix printed3552 != trioRuleMatrixOf2 printed3552

/-- The 783 labels and the printed label of row 3552, with the merged matrices. -/
def chosenDataFix3 : Array (Od × List (List Nat)) :=
  ((chosen ++ [printed3552]).map fun s => ((parse s).getD [], fixOf s)).toArray

#guard chosenDataFix3.size = 784
#guard chosenDataFix3.all fun p => !p.1.isEmpty && !p.2.isEmpty
#guard orderDisagreements chosenDataFix3 = 0

#guard fixOf printed3552 = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[7,3,1],[8,3,1],[9,2,0],[2,2,1],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[7,3,0]]
#guard fixOf printed3552 =
  fixOf "psi_W_(W+1)(W_W_2)" ++ liftRows ((fixOf "psi_W_(w+1)(W_(w+1))").drop 4)
#guard fixOf "psi_W_(W+1)(W_W_2)" < fixOf "psi_W_(W+1)(W_W_w)"
#guard fixOf "psi_W_(W+1)(W_W_w)" < fixOf printed3552
#guard fixOf printed3552 < fixOf "W_(W+1)"
#guard (List.range 4).all fun n =>
  expandRL 3 n (fixOf printed3552) =
    fixOf "psi_W_(W+1)(W_W_2)" ++
      liftRows ((expandRL 3 n (fixOf "psi_W_(w+1)(W_(w+1))")).drop 4)
#guard fixOf "psi_W_(W+1)(W_W_w)" = fixOf "psi_W_(W+1)(W_W_2)" ++ [[2,2,1]]
#guard expandRL 3 1 (fixOf "psi_W_(W+1)(W_W_w)") =
  fixOf "psi_W_(W+1)(W_W_2)" ++
    [[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[8,4,1],[9,4,1],[10,3,0]]
#guard expandRL 3 2 (fixOf "W_(W+1)") = fixOf "psi_W_(W+1)(W_W_2)" ++ [[10,3,1],[11,3,1]]
#guard fixOf "psi_W_(W+1)(W_psi_W_(W+1)(W_(W+1)))" = fixOf "psi_W_(W+1)(W_W_2)" ++ [[10,3,0]]
#guard expandRL 3 2 (fixOf "psi_W_(W+1)(W_psi_W_(W+1)(W_(W+1)))") =
  fixOf "psi_W_(W+1)(W_W_2)" ++ [[10,2,0],[11,2,0]]
#guard fixOf printed3552 < fixOf "psi_W_(W+1)(W_psi_W_(W+1)(W_(W+1)))"
#guard fixOf "psi_W_(w+1)(W_W)" = row3550
#guard fixOf "psi_W_(w+1)(W_W_w)" = row3550 ++ [[6,2,1]]
...
#guard (sheetLabels.filter (· != printed3552)).all fun s => trioRuleMatrixOfFix s == trioRuleMatrixOfN s
#guard sheetLabels.all fun s => trioRuleMatrixOfFix s == trioRuleMatrixOf3 s

-- Fix N on the plan's case, the lifted copy, and BMS expansion.
#guard fixOf "(W_W_W+W_W_2+1)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,4,0],[5,4,1],[6,4,1],[7,2,0],[6,4,0],[7,5,0]]
#guard fixOf "(W_W_W+W_(W+1)+1)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,2,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,3,0],[10,6,0],[11,7,0]]
#guard fixOf "(W_W_W*2+1)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[9,5,0],[10,6,0]]
#guard fixOf "(W_W+W_2+1)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,2,0],[8,5,0],[9,6,0]]
#guard fixOf "(W_W*2+1)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,2,0],[7,4,0],[8,5,0]]
#guard fixOf "(W_W_W+W_W_2*2)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,4,0],[5,4,1],[6,4,1],[7,2,0],[6,4,0],[7,5,1],[8,5,1],[9,3,0],[5,4,1],[6,4,1],[7,2,0]]
#guard fixOf "(W_W_W+W_W_2*w)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,4,0],[5,4,1],[6,4,1],[7,2,0],[6,4,0],[7,5,1],[8,5,1],[9,3,0],[8,5,1]]
...
#guard cmpMat (fixOf "(W_W_W+W_W_2)") (fixOf "(W_W_W+W_W_2+1)") = .lt
#guard cmpMat (fixOf "(W_W_W+W_W_2+1)") (fixOf "(W_W_W+W_W_2*2)") = .lt
#guard cmpMat (fixOf "(W_W_W+W_W_2*2)") (fixOf "(W_W_W*2)") = .lt
#guard cmpMat (fixOf "(W_W_W+W_(W+1)+1)") (fixOf "(W_W_W+W_W_2)") = .lt
#guard cmpMat (fixOf "(W_W_W*2)") (fixOf "(W_W_W*2+1)") = .lt
#guard cmpMat (fixOf "(W_W+W_2+1)") (fixOf "(W_W*2)") = .lt
#guard cmpMat (fixOf "(W_W+W_2+1)") (fixOf "(W_W+W_w)") = .lt
#guard expandRL 3 1 (fixOf "(W_W_W+W_W_w)") =
  toRows (MFix ((parse "(W_W_W+W_W_2)").getD []) ++ bliftUp (MFix ((parse "(W_W_W+W_W_2)").getD [])) 10)
#guard expandRL 3 1 (fixOf "(W_W_W+W_w)") =
  toRows (MFix ((parse "(W_W_W+W_2)").getD []) ++ bliftUp (MFix ((parse "(W_W_W+W_2)").getD [])) 10)
#guard expandRL 3 1 (fixOf "(W_W+W_w)") =
  toRows (MFix ((parse "(W_W+W_2)").getD []) ++ bliftUp (MFix ((parse "(W_W+W_2)").getD [])) 7)
#guard expandRL 3 1 (fixOf "(W_W*w)") = fixOf "(W_W+W_2)"
#guard expandRL 3 2 (fixOf "(W_W*w)") = fixOf "(W_W*2+W_2)"
#guard expandRL 3 1 (fixOf "(W_W_W*w)") = fixOf "(W_W_W+W_(W+1))"
#guard expandRL 3 2 (fixOf "(W_W_W*w)") = fixOf "(W_W_W*2+W_(W+1))"
#guard expandRL 3 1 (fixOf "(W_W_W^2*w)") = fixOf "(W_W_W^2+W_W_W*W_(W+1))"
#guard expandRL 3 2 (fixOf "(W_W_W^2*w)") = fixOf "(W_W_W^2*2+W_W_W*W_(W+1))"
#guard expandRL 3 1 (fixOf "(W_W_W+W_2*w)") = fixOf "(W_W_W+W_2*2)"
#guard expandRL 3 2 (fixOf "(W_W_W+W_2*w)") = fixOf "(W_W_W+W_2*3)"
#guard expandRL 3 1 (fixOf "(W_W_W+W_(W+1)*w)") = fixOf "(W_W_W+W_(W+1)*2)"
#guard expandRL 3 2 (fixOf "(W_W_W+W_(W+1)*w)") = fixOf "(W_W_W+W_(W+1)*3)"
#guard expandRL 3 1 (fixOf "(W_W_W+W_W_2*w)") = fixOf "(W_W_W+W_W_2*2+W_(W+1))"
#guard expandRL 3 2 (fixOf "(W_W_W+W_W_2*w)") = fixOf "(W_W_W+W_W_2*3+W_(W+1))"
#guard expandRL 3 1 (fixOf "(W_W_W*W_2*w)") = fixOf "(W_W_W*W_2*2)"
#guard expandRL 3 2 (fixOf "(W_W_W*W_2*w)") = fixOf "(W_W_W*W_2*3)"
#guard expandRL 3 1 (fixOf "(W_W_W*W_(W+1)*w)") = fixOf "(W_W_W*W_(W+1)*2)"
#guard expandRL 3 2 (fixOf "(W_W_W*W_(W+1)*w)") = fixOf "(W_W_W*W_(W+1)*3)"
#guard expandRL 3 1 (fixOf "(W_W_W*W_W_2*w)") = fixOf "(W_W_W*W_W_2*2+W_W_W*W_(W+1))"
#guard expandRL 3 1 (fixOf "(W_W_W+W_W_2+W_2*w)") = fixOf "(W_W_W+W_W_2+W_2*2)"
#guard expandRL 3 2 (fixOf "(W_W_W+W_W_2+W_2*w)") = fixOf "(W_W_W+W_W_2+W_2*3)"
#guard expandRL 3 1 (fixOf "(W_W_W+W_(W+1)+W_2*w)") = fixOf "(W_W_W+W_(W+1)+W_2*2)"
#guard expandRL 3 2 (fixOf "(W_W_W+W_(W+1)+W_2*w)") = fixOf "(W_W_W+W_(W+1)+W_2*3)"
#guard expandRL 3 1 (fixOf "(W_W_W+W_W_2+W_(W+1)*w)") = fixOf "(W_W_W+W_W_2+W_(W+1)*2)"
#guard expandRL 3 2 (fixOf "(W_W_W+W_W_2+W_(W+1)*w)") = fixOf "(W_W_W+W_W_2+W_(W+1)*3)"
#guard expandRL 3 1 (fixOf "(W_W+W_2*w)") = fixOf "(W_W+W_2*2)"
#guard expandRL 3 2 (fixOf "(W_W+W_2*w)") = fixOf "(W_W+W_2*3)"
#guard expandRL 3 1 (fixOf "(W_W+W_2+W*w)") = fixOf "(W_W+W_2+W*2)"
#guard expandRL 3 2 (fixOf "(W_W+W_2+W*w)") = fixOf "(W_W+W_2+W*3)"

-- The nearby families: the same counts as with Fix N alone.
#guard pairDisagreements (withM fixOf familyW) = 1 ∧ collisions (withM fixOf familyW) = 1
#guard pairDisagreements (withM fixOf family1) = 0 ∧ collisions (withM fixOf family1) = 0
#guard pairDisagreements (withM fixOf probes) = 25
#guard crossDisagreements (withM fixOf probes) chosenDataFix = 20
#guard crossDisagreements (withM fixOf probes) chosenDataFix3 = 20

/-! ## Part 5: against rules 1–10 and the single-fix versions

`interactionsF ls` lists the labels of `ls` where the merged matrix is not the one
...
def interactionsF (ls : List String) : List String :=
  ls.filter fun s =>
    let a := fixOf s
    let o := ruleOf2 s
    let e := ruleOf3 s
...
#guard interactionsF sheetLabels = []
#guard interactionsF familyW = []
#guard interactionsF family1 = []
#guard interactionsF probes = []

-- Against rules 1–10: 24 labels differ (22 `S` rows, row 4533, printed row 3552);
-- `TrioRules2` differs on 23 of them.
#guard (sheetLabels.filter fun s => trioRuleMatrixOfFix s != trioRuleMatrixOf s).length = 24
#guard (sheetLabels.filter fun s => trioRuleMatrixOf2 s != trioRuleMatrixOf s).length = 23
#guard (sheetLabels.filter fun s => trioRuleMatrixOfFix s != trioRuleMatrixOf s).all fun s =>
...
/-- Labels around the meeting points. -/
def probesENF : List String := [
  "(W_W_W_W+W_psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1)))+1)",
  "(W_W_W_W+W_psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1))))",
  ...
  "(W_W_W_W+W_psi_W_(W+1)(W_W_w))",
  "(W_W_W_W+W_psi_W_(W+1)(W_W_w)+1)",
  "(W_W_W_W+W_psi_W_(W+1)(W_W_w+1))",
  "(W_W_W_W+W_psi_W_(W+1)(W_W_w+1)+1)",
  "(W_W_W_W+W_psi_W_(W+1)(W_W_2)+1)",
  "(W_W_W_W+W_psi_W_(W+1)(W_W_2)+W_psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1))))",
  "(W_W_W_W*W_psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1)))*2)",
  "psi_W_(W+1)(W_psi_W_(w+1)(W_(W_W_W+W_W_2+1)))",
  "psi_W_(W+1)(W_psi_W_(w+1)(W_(W_W+W_2+1)))",
  "psi_W_(W+1)(W_psi_W_(w+1)(W_(W_W_W+W_(W+1)+1)))",
  "psi_W_(W+1)(W_psi_W_(w+1)(W_(W_W_W*2+1)))",
  "psi_W_(W+1)(W_psi_W_(w+1)(W_(W_W_W+W_W_2)))",
  "W_psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1)))",
  "(W_psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1)))+1)",
  "(W_W_psi_W_(W+1)(W_psi_W_(w+1)(W_(w+1)))+W_2+1)"]

#guard probesENF.all fun s => (parse s).isSome

/-- `(Fix E changes it, Fix N changes it, merged = E, merged = N)`. -/
def meetF (s : String) : Bool × Bool × Bool × Bool :=
  (ruleOf3 s != ruleOf2 s, nOf s != ruleOf2 s, fixOf s == ruleOf3 s, fixOf s == nOf s)
...
#guard interactionsF probesENF = [
  ...
  "psi_W_(W+1)(W_psi_W_(w+1)(W_(W_W+W_2+1)))",
  "psi_W_(W+1)(W_psi_W_(w+1)(W_(W_W_W+W_(W+1)+1)))"]
#guard (interactionsF probesENF).all fun s => meetF s == (true, true, false, false)
-- On the other 12, only one fix acts and the merged matrix is that version's.
#guard (probesENF.filter fun s => !(interactionsF probesENF).contains s).all fun s =>
  let m := meetF s
...
-- collisions).
#guard crossDisagreements (withM fixOf probesENF) chosenDataFix3 = 0
#guard crossDisagreements (withM nOf probesENF)
  (((chosen ++ [printed3552]).map fun s => ((parse s).getD [], nOf s)).toArray) = 5
#guard pairDisagreements (withM fixOf probesENF) = 3 ∧ collisions (withM fixOf probesENF) = 3
#guard pairDisagreements (withM ruleOf3 probesENF) = 11 ∧ collisions (withM ruleOf3 probesENF) = 8
#guard fixOf "psi_W_(W+1)(W_W_w)" = fixOf "psi_W_(W+1)(W_W_w+1)"

/-! ## Part 7: one step against rules 1–10

With the same `Mf` (the merged builder one step of fuel down), compare the merged
step `MstepFix` with `Mstep` of `TrioRules.lean` on every label used above (1,225
labels with repeats), by branchF.  On countable `α` they agree everywhere (none of
...
they differ on 257 of 870. -/

/-- Every label used in this file. -/
def corpusF : List String := sheetLabels ++ familyW ++ family1 ++ probes ++ probesENF

/-- The merged builder one step of fuel down. -/
def MfPrevF : Od → Cols := MfuelFix (fuel - 1)

/-- The branchF of the builder that `α` takes. -/
def branchF (a : Od) : String :=
  match lvlO a with
  | none => "countable"
  | some v => match isPsiLevel a with
    | some _ => "psi"
    | none => if a == [(.W v, 1)] then "omega" else "sum"

/-- The merged step and rules 1–10's step differ on the label, with the same `Mf`. -/
def stepDiffersF (s : String) : Bool :=
  let a := (parse s).getD []
  MstepFix MfPrevF a != Mstep MfPrevF a

/-- `MFix` is one merged step on `MfPrevF`. -/
theorem MFix_eq_step : MFix = MstepFix MfPrevF := rfl

#guard (["countable", "psi", "omega", "sum"].map fun k =>
    let ls := corpusF.filter fun s => branchF ((parse s).getD []) == k
    (k, ls.length, (ls.filter stepDiffersF).length)) =
  [("countable", 171, 0), ("psi", 32, 6), ("omega", 152, 7), ("sum", 870, 257)]
#guard (corpusF.filter fun s => branchF ((parse s).getD []) == "psi").all fun s =>
  match isPsiLevel ((parse s).getD []) with
  | some uX => stepDiffersF s == (fixAFires MfPrevF uX.1 || fixEFires MfPrevF uX.1 uX.2)
  | none => false
#guard (corpusF.filter fun s => branchF ((parse s).getD []) == "omega").all fun s =>
  match lvlO ((parse s).getD []) with
  | some v => stepDiffersF s == fixAFires MfPrevF v
  | none => false


/-! ## Part 8: Fix L on its own item

The levels `Ω_3`, `Ω_{Ω+2}`, `Ω_{Ω·2}`, `Ω_{Ω_2+1}`, `Ω_{Ω_3}` as the last leaf after
`Ω_{Ω_Ω}`, and `Ω_3` after `Ω_Ω`. -/

/-! ### Before: `TrioRulesAll.lean` -/

-- Two collisions: `Ω_3` reads as `Ω_{Ω+1}`, `Ω_{Ω·2}` as `Ω_2`.
#guard TrioRulesAll.allOf "W_W_W+W_3" = TrioRulesAll.allOf "W_W_W+W_(W+1)"
#guard TrioRulesAll.allOf "W_W_W+W_(W*2)" = TrioRulesAll.allOf "W_W_W+W_2"
-- The other four end in a leaf that is too high (not standard, yaBMS `bms -s`):
-- `(10,4,0)` after `Ω_{Ω_Ω}` for `Ω_{Ω+2}`, `Ω_{Ω_2+1}`, `Ω_{Ω_3}`, `(8,3,0)` after `Ω_Ω`.
#guard (TrioRulesAll.allOf "W_W_W+W_(W+2)").getLast? = some [10,4,0]
#guard (TrioRulesAll.allOf "W_W_W+W_(W_2+1)").getLast? = some [10,4,0]
#guard (TrioRulesAll.allOf "W_W_W+W_W_3").getD 34 [] = [10,4,0]
#guard (TrioRulesAll.allOf "W_W+W_3").getLast? = some [8,3,0]

/-! ### After: the six matrices (all standard, yaBMS `bms -s`) -/

#guard fixOf "W_W_W+W_3" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,3,0]]
#guard fixOf "W_W_W+W_(W+2)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,2,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,4,0]]
#guard fixOf "W_W_W+W_(W*2)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,1,0]]
#guard fixOf "W_W_W+W_(W_2+1)" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,4,0],[5,4,1],[6,4,1],[7,2,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0]]
#guard fixOf "W_W_W+W_W_3" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,3,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,3,0],[7,4,0],[8,5,1],[9,5,1],[10,3,0],[4,3,1],[5,3,1],[6,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,4,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,4,0],[8,5,0],[9,6,1],[10,6,1],[11,4,0],[5,4,1],[6,4,1],[7,3,0]]
#guard fixOf "W_W+W_3" = [[0,0,0],[1,1,1],[2,1,1],[3,1,0],[1,1,1],[2,1,1],[3,1,0],[1,1,0],[2,2,1],[3,2,1],[4,2,0],[2,2,1],[3,2,1],[4,1,0],[3,2,0],[4,3,1],[5,3,1],[6,2,0],[5,3,0],[6,4,1],[7,4,1],[8,2,0],[2,2,0],[3,3,1],[4,3,1],[5,3,0],[3,3,1],[4,3,1],[5,1,0],[4,3,0],[5,4,1],[6,4,1],[7,3,0],[6,4,0],[7,5,1],[8,5,1],[9,3,0]]

/-! ### The four cases, as identities -/

-- L: the lifted copy of `M(γ + Ω_2)` from `P₁` of its last leaf (column 10, `(1,1,0)`).
#guard MFix ((parse "W_W_W+W_3").getD []) =
  MFix ((parse "W_W_W+W_2").getD []) ++ liftAt (MFix ((parse "W_W_W+W_2").getD [])) 10
#guard copyRoot (MFix ((parse "W_W_W+W_2").getD [])) = 10
#guard MFix ((parse "W_W_W+W_W_3").getD []) =
  MFix ((parse "W_W_W+W_W_2").getD []) ++ liftAt (MFix ((parse "W_W_W+W_W_2").getD [])) 10
#guard MFix ((parse "W_W_W+W_(W+2)").getD []) =
  MFix ((parse "W_W_W+W_(W+1)").getD []) ++ liftAt (MFix ((parse "W_W_W+W_(W+1)").getD [])) 20
#guard MFix ((parse "W_W+W_3").getD []) =
  MFix ((parse "W_W+W_2").getD []) ++ liftAt (MFix ((parse "W_W+W_2").getD [])) 7
-- L after a lifted copy: the copy of the copy (`copyRoot` moves from 35 to its start).
#guard copyRoot (MFix ((parse "W_W_W+W_3").getD [])) = 35
#guard MFix ((parse "W_W_W+W_4").getD []) =
  MFix ((parse "W_W_W+W_3").getD []) ++ liftAt (MFix ((parse "W_W_W+W_3").getD [])) 35
-- K: `M(γ+Ω_{Ω_2})`, its kept copy (Fix N 2), and the unit `(6,4,0)(7,5,1)(8,5,1)(9,4,0)`,
-- whose leaf `4` is `N(Ω_Ω) + 1`.  The kept copy is the one Fix N lays for
-- `Ω_{Ω_Ω}+Ω_{Ω_2}+1`.
#guard fixOf "W_W_W+W_(W_2+1)" =
  (fixOf "W_W_W+W_W_2+1").dropLast.dropLast ++ [[6,4,0],[7,5,1],[8,5,1],[9,4,0]]
-- K': K and the mark `(5,4,1)` (the suffix of `M(Ω_2+ω)`).
#guard fixOf "W_W_W+W_(W_2+w)" = fixOf "W_W_W+W_(W_2+1)" ++ [[5,4,1]]
-- D: `M(γ+Ω_{Ω_2})` with its last leaf `2` set to `N(1) = 1`; the tail after
-- `M(γ+Ω_{Ω+1})` is the tail the sheet's row 4502 puts after `M(Ω_{Ω+1})`.
#guard fixOf "W_W_W+W_(W*2)" = (fixOf "W_W_W+W_W_2").dropLast ++ [[6,1,0]]
#guard fixOf "W_W_W+W_(W*2)" = fixOf "W_W_W+W_(W+1)" ++ [[4,3,1],[5,3,1],[6,1,0]]
#guard fixOf "W_(W*2)" = fixOf "W_(W+1)" ++ [[4,3,1],[5,3,1],[6,1,0]]
#guard (sheetLabels.contains "W_(W2)") && fixOf "W_(W2)" == fixOf "W_(W*2)"

/-! ### Order around the six levels -/

/-- Labels whose ordinals increase, and whose matrices must increase too. -/
def chainOK (ls : List String) : Bool :=
  let xs := ls.map fun s => ((parse s).getD [], fixOf s)
  (xs.zip (xs.drop 1)).all fun ab =>
    cmpOrd ab.1.1 ab.2.1 == .lt && cmpMat ab.1.2 ab.2.2 == .lt

#guard chainOK ["W_W_W+W_2", "W_W_W+W_3", "W_W_W+W_4", "W_W_W+W_w", "W_W_W+W_W",
  "W_W_W+W_(W+1)", "W_W_W+W_(W+2)", "W_W_W+W_(W+3)", "W_W_W+W_(W+w)", "W_W_W+W_(W*2)",
  "W_W_W+W_W_2", "W_W_W+W_W_2+1", "W_W_W+W_W_2*2", "W_W_W+W_(W_2+1)", "W_W_W+W_(W_2+2)",
  "W_W_W+W_(W_2+w)", "W_W_W+W_W_3", "W_W_W+W_W_4", "W_W_W+W_W_w", "W_W_W*2"]
#guard chainOK ["W_W+W_2", "W_W+W_2+1", "W_W+W_3", "W_W+W_4", "W_W+W_w", "W_W*2"]
-- `M(γ+Ω_{Ω·2})[0]` is `M(γ+Ω_{Ω+ω²})`; `[1]` goes on with a countable `ψ_0` column.
#guard expandRL 3 0 (fixOf "W_W_W+W_(W*2)") = fixOf "W_W_W+W_(W+w^2)"
#guard (expandRL 3 1 (fixOf "W_W_W+W_(W*2)")).take 38 = fixOf "W_W_W+W_(W+w^2)" ++ [[6,0,0]]

/-! ### BMS expansion lands on Fix L's matrices

`M(λ)[n]` (BM4, `n+1` copies) for a limit `λ = γ + Ω_{c+ω}` is Fix L's `M(γ + Ω_{c+n+1})`
(`n = 0` gives the level below, which Fix L does not touch). -/

#guard ([(0, "W_W_W+W_2"), (1, "W_W_W+W_3"), (2, "W_W_W+W_4"), (3, "W_W_W+W_5")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W+W_w") = fixOf p.2
#guard ([(0, "W_W+W_2"), (1, "W_W+W_3"), (2, "W_W+W_4"), (3, "W_W+W_5")]).all fun p => expandRL 3 p.1 (fixOf "W_W+W_w") = fixOf p.2
#guard ([(0, "W_W_W+W_(W+1)"), (1, "W_W_W+W_(W+2)"), (2, "W_W_W+W_(W+3)"), (3, "W_W_W+W_(W+4)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W+W_(W+w)") = fixOf p.2
#guard ([(0, "W_W_W+W_W_2"), (1, "W_W_W+W_W_3"), (2, "W_W_W+W_W_4"), (3, "W_W_W+W_W_5")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W+W_W_w") = fixOf p.2
#guard ([(0, "W_W_W*W_2"), (1, "W_W_W*W_3"), (2, "W_W_W*W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W*W_w") = fixOf p.2
#guard ([(0, "W_W*W_2"), (1, "W_W*W_3"), (2, "W_W*W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W*W_w") = fixOf p.2
#guard ([(0, "W_W_W*W_W_2"), (1, "W_W_W*W_W_3"), (2, "W_W_W*W_W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W*W_W_w") = fixOf p.2
#guard ([(0, "W_W_W*2+W_2"), (1, "W_W_W*2+W_3"), (2, "W_W_W*2+W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W*2+W_w") = fixOf p.2
#guard ([(0, "W_W_W+W_W_2+W_2"), (1, "W_W_W+W_W_2+W_3"), (2, "W_W_W+W_W_2+W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W+W_W_2+W_w") = fixOf p.2
#guard ([(0, "W_W_W+W_(W+1)+W_2"), (1, "W_W_W+W_(W+1)+W_3"), (2, "W_W_W+W_(W+1)+W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W+W_(W+1)+W_w") = fixOf p.2
#guard ([(0, "W_W_W_W+W_2"), (1, "W_W_W_W+W_3"), (2, "W_W_W_W+W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_w") = fixOf p.2
#guard ([(0, "W_W_W_W+W_(W+1)"), (1, "W_W_W_W+W_(W+2)"), (2, "W_W_W_W+W_(W+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_(W+w)") = fixOf p.2
#guard ([(0, "W_W_W_W+W_W_2"), (1, "W_W_W_W+W_W_3"), (2, "W_W_W_W+W_W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_W_w") = fixOf p.2
#guard ([(0, "W_W_W_W+W_(W_W+1)"), (1, "W_W_W_W+W_(W_W+2)"), (2, "W_W_W_W+W_(W_W+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_(W_W+w)") = fixOf p.2
#guard ([(0, "W_W_W_W+W_W_W_2"), (1, "W_W_W_W+W_W_W_3"), (2, "W_W_W_W+W_W_W_4")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_W_W_w") = fixOf p.2
#guard ([(0, "W_W_W_W+W_W_(W+1)"), (1, "W_W_W_W+W_W_(W+2)"), (2, "W_W_W_W+W_W_(W+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_W_(W+w)") = fixOf p.2
-- K and K' together: the mark after K expands to K, then to L on K.
#guard ([(0, "W_W_W+W_(W_2+1)"), (1, "W_W_W+W_(W_2+2)"), (2, "W_W_W+W_(W_2+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W+W_(W_2+w)") = fixOf p.2
#guard ([(0, "W_W_W_W+W_(W_W_2+1)"), (1, "W_W_W_W+W_(W_W_2+2)"), (2, "W_W_W_W+W_(W_W_2+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_(W_W_2+w)") = fixOf p.2
#guard ([(0, "W_W_W_W+W_(W_2+1)"), (1, "W_W_W_W+W_(W_2+2)"), (2, "W_W_W_W+W_(W_2+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W_W+W_(W_2+w)") = fixOf p.2
#guard ([(0, "W_W_W+W_W_2+W_(W_2+1)"), (1, "W_W_W+W_W_2+W_(W_2+2)"), (2, "W_W_W+W_W_2+W_(W_2+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W+W_W_2+W_(W_2+w)") = fixOf p.2
#guard ([(0, "W_W_W*W_(W_2+1)"), (1, "W_W_W*W_(W_2+2)"), (2, "W_W_W*W_(W_2+3)")]).all fun p => expandRL 3 p.1 (fixOf "W_W_W*W_(W_2+w)") = fixOf p.2

/-! ### A family of last leaves

Sums `γ + Ω_p` for `γ ∈ {Ω_{Ω_Ω}, Ω_{Ω_Ω}·2, Ω_{Ω_Ω}+Ω_{Ω_2}, Ω_{Ω_Ω}+Ω_{Ω+1}, Ω_{Ω_Ω}+Ω_2}`,
`{Ω_Ω, Ω_Ω·2, Ω_Ω+Ω_2}`, `{Ω_{Ω_{Ω_Ω}}, Ω_{Ω_{Ω_Ω}}·2}`, products `Ω_{Ω_Ω}·Ω_p`,
`Ω_{Ω_{Ω_Ω}}·Ω_p`, with `p` from `2, 3, 4, ω, Ω, Ω+1, Ω+2, Ω+3, Ω+ω, Ω·2, Ω_2, Ω_2+1,
Ω_2+2, Ω_2+ω, Ω_3, Ω_4, Ω_ω, …` (151 normal forms).  All 151 Fix L matrices are
standard (yaBMS `bms -s`; `TrioRulesAll`: 43 are not). -/

/-- The last-leaf family. -/
def familyLast : List String := [
  "W_W_W",
  "W_W_W+W",
  "W_W_W+W_2",
  "W_W_W+W_3",
  ...
  "W_W_W_W+W_W_W_(W*2)",
  "W_W_W_W+W_W_W_W_2",
  "W_W_W_W+W_W_W_(W_2+1)"]

/-- The same sums followed by `+1`: the fixed levels as a leaf that is not last. -/
def familyPlus1 : List String := [
  "W_W_W+W+1",
  "W_W_W+W_2+1",
  "W_W_W+W_3+1",
  "W_W_W+W_4+1",
  ...
  "W_W_W+W_W_2+W_(W+2)+1",
  "W_W_W+W_W_2+W_(W+3)+1",
  "W_W_W+W_W_2+W_(W+w)+1",
  "W_W_W+W_W_2+W_(W*2)+1",
  "W_W_W+W_W_2+W_W_2+1",
  "W_W_W+W_(W+1)+W+1",
  "W_W_W+W_(W+1)+W_2+1",
...
#guard familyLast.length = 151 ∧ familyPlus1.length = 69
#guard familyLast.all fun s => (parse s).isSome
-- Fix L: no disagreement, no collision; against the 784 chosen matrices, none.
#guard pairDisagreements (withM fixOf familyLast) = 0 ∧ collisions (withM fixOf familyLast) = 0
#guard crossDisagreements (withM fixOf familyLast) chosenDataFix3 = 0
-- `TrioRulesAll`: 555 disagreements, 49 collisions, 51 against the chosen matrices.
#guard pairDisagreements (withM TrioRulesAll.allOf familyLast) = 555 ∧
  collisions (withM TrioRulesAll.allOf familyLast) = 49
#guard crossDisagreements (withM TrioRulesAll.allOf familyLast) chosenDataFix3 = 51
-- Fix L changes 79 of the 151.
#guard (familyLast.filter fun s => fixOf s != TrioRulesAll.allOf s).length = 79
-- Not fixed: a leaf that is not last.  Fix L leaves `+1` after these levels as it was
-- (340 disagreements, 26 collisions in both; 21 of the 69 are not standard).
#guard (familyPlus1.all fun s => fixOf s == TrioRulesAll.allOf s)
#guard pairDisagreements (withM fixOf familyPlus1) = 340 ∧ collisions (withM fixOf familyPlus1) = 26
-- Not fixed: `Ω_{Ω_{Ω_2+1}}` and `Ω_{Ω_{Ω_2+ω}}` after `Ω_{Ω_{Ω_Ω}}` (K and K' inside a
-- chain; Fix L does not act, the matrix is `TrioRulesAll`'s and lies above `Ω_{Ω_{Ω_3}}`).
#guard fixOf "W_W_W_W+W_W_(W_2+1)" == TrioRulesAll.allOf "W_W_W_W+W_W_(W_2+1)"
#guard cmpMat (fixOf "W_W_W_W+W_W_(W_2+1)") (fixOf "W_W_W_W+W_W_W_3") == .gt

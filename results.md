...
| **For any number of rows, a list of blocks is standard iff each content is reachable from the earlier ones** | `Trans.DBMS.dstdL_iff_dchain`, `Trans.DBMS.dupProp`, `Trans.DBMS.dstdL_of_dchain` |
